                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" style=" max-width: 450px; max-heigh: 800px" src="admin/<?php echo $info_product['product_thumb']; ?>" data-zoom-image="admin/<?php echo $info_product['product_thumb']; ?>" />
                        </a>
                        <div id="list-thumb">
                    ...
                    <div class="info fl-right">
                        ...
                        <a href="?mod=cart&action=add&product_id=<?php echo $info_product['product_id']; ?>" title="Liên hệ" class="add-cart">Liên hệ</a>
                    </div>
                </div>
            </div>
                            ...
                            ?>
                                <li>
                                    ...
                                    <div class="action clearfix">
                                        ...
                                        <a href="?mod=product&action=detail&product_id=<?php echo $item['product_id']; ?>" title="" class="buy-now fl-right">Liên hệ</a>
                                    </div>
                                </li>
                        <?php }
                        }
