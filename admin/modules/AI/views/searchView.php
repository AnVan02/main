            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-fluid" src="<?php if (!empty($item['ai_thumb'])) {
                                                                            echo $item['ai_thumb'];
                                                                        } else {
                                        ...
                                        <td>
                                            <a href="<?php echo "?mod=ai&action=update&ai_id={$item['ai_id']}"; ?>" class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo "?mod=ai&action=delete&ai_id={$item['ai_id']}"; ?>" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php
                    ...
                    <nav aria-label="Page navigation example">
                        <?php
                        echo get_pagging($num_page, $page, "?mod=ai&action=search");
                        ?>
                    </nav>
                </div>
            </div>
