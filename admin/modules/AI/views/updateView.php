                ...
                <div class="card-body">
                    <form action="" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            <label for="ai_title">Tiêu đề bài viết</label>
                            <input class="form-control" type="text" name="ai_title" id="ai_title" value="<?php echo $info_post['ai_title']; ?>">
                            <?php echo form_error('ai_title'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ai_content">Nội dung bài viết</label>
                            <textarea name="ai_content" class="form-control ckeditor" id="ai_content" cols="30" rows="5"><?php echo $info_post['ai_content']; ?></textarea>
                            <?php echo form_error('ai_content'); ?>
                        </div>
                        <div class="form-group">
                            <label>
                                <h6> Ảnh đại diện</h6>
                            ...
                            <p>
                                <img class="form-input" src="<?php echo $info_post['ai_thumb']; ?>" width="220" height="320" alt="">
                            </p>
